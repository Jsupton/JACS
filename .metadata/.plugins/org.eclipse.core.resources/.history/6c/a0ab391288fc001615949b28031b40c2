...
public class DBController {
	 ...
	 */
	public boolean searchCriteriaEmpty(String criteria)
	{
		return false;
	}
	/**
	 ...
	 * @return
	 */
	public ArrayList<University> search(String criteria)
	{
		return null;
	}
	/**
	 ...
	 * 
	 */
	public void changeStudentDetails(Full Criteria, Account)
	{
		return null;
	}
	...
	public void editAccount(fn, ln, p)
	{
